...
# built plain.
#
# Before adding a fallback, this reports where the colour IS, per body:
#
...
#
# If every body reports appearance=None but its occurrence or component has one,
# a fallback chain would fix it and this says which link to add. If the bodies
# genuinely have no colour anywhere, the answer is to assign one and nothing
# needs changing in the add-in.
#
